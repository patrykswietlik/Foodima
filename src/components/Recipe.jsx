...
const Recipe = ({ recipe, resetRecipes }) => {
	return (
		<section className='py-4 pt-0 mt-12 bg-white flex flex-col border-2 border-e-gray rounded-2xl shadow-xl overflow-hidden'>
			<div className='relative h-24 flex items-center justify-center'>
				<h2 className='text-4xl text-e-yellow font-extrabold uppercase z-10'>{recipe.name}</h2>
				<div className='absolute top-0 left-0 p-2 z-10'>
					<Button onClick={resetRecipes} className='bg-e-yellow'>
						Go Back
					</Button>
				</div>
				<img
